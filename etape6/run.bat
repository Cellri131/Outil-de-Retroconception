...
javac -d class src/metier/util/*.java src/metier/lecture/*.java src/metier/objet/*.java src/metier/sauvegarde/*.java src/controleur/*.java src/vue/*.java src/vue/liaison/*.java src/metier/util/test_structure_projet/*.java
