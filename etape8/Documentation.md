...
#### <div style="color:#E74C3C;">public Controleur()</div>
...
#### <div style="color:#FFB347;">public static void main(String[] args)</div>
...
#### <div style="color:#FFB347;">parser(Scanner scFic, String nomFichierAvExt)</div>
...
#### <div style="color:#FFB347;">parserAttribut(String ligne)</div>

<div style="color:#5D8AA8;">
Cette méthode permet de creer et de retourner un Attribut, qu'elle ajoute par la suite dans la liste d'attributs.<br>
Elle extrait la visibilite, les modificateurs(final ou static), la portée(classe/Instance), le type et le nom.
</div>

---

#### <div style="color:#FFB347;">parserMethode(String ligne, String nomFichier, String typeClasse, boolean ligneCommenceParModificateur, boolean estMethodeInterface, String nomMethode, String nomConstructeur, List&lt;Parametre&gt; lstParametres)</div>
...
#### <div style="color:#FFB347;">parserParametre(String params)</div>
...
#### <div style="color:#FFB347;">generer()</div>
...
#### <div style="color:#FFB347;">traiterMultiInstance(Classe classeOrig, ArrayList&lt;String&gt; listeMultiInstance)</div>
...
#### <div style="color:#FFB347;">estBidirectionnel(Classe classeOrig, Classe classeDest)</div>
<div style="color:#5D8AA8;">Méthode qui vérifie si une association donnée est bidirectionnelle. Renvoie un booléen.</div>

#### <div style="color:#FFB347;">nettoyerAssociations())</div>
...
#### <div style="color:#FFB347;">analyser(String cheminFichier)</div>
...
#### <div style="color:#FFB347;">nettoyerType(String type)</div>

<div style="color:#5D8AA8;">
Nettoie le string de type entré pour retirer des élements en trop comme "List&lt;&gt;", "Set&lt;&gt;" ou "[]" et renvoie le résultat
</div>

#### <div style="color:#FFB347;">estMultiInstance(String type)</div>
...
#### <div style="color:#FFB347;">lectureLiaison(String dossierFichSelec, Map&lt;String, BlocClasse&gt; hashMapBlocClass)</div>
...
#### <div style="color:#FFB347;">chargerBlocsClasses(String nomProjet)</div>
...
#### <div style="color:#FFB347;">sauvegarderClasses(List&lt;BlocClasse&gt; listBlocClasses, List&lt;LiaisonVue&gt; listLiaison, String cheminProjet)</div>
<div style="color:#5D8AA8;">
...
#### <div style="color:#FFB347;"> sauvegardeProjetXml </div>
<div style="color:#5D8AA8;">
...
#### <div style="color:#FFB347;">dessinerLigneAvecPonts(Graphics2D g, Point p1, Point p2, List&lt;Point&gt; intersections, Stroke traitNormal)</div>
...
#### <div style="color:#FFB347;">dessinerFlecheVide(Graphics2D g, Point a, int s)</div>
...
#### <div style="color:#FFB347;">dessinerFlecheAssociation(Graphics2D g, Point a, int s)</div>
